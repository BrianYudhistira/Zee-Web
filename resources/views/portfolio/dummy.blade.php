          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('name') }}"
                required
                class="w-full p-3 bg-gray-800 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary transition-colors @error('name') border-red-500 @else border-gray-600 @enderror"
              />
              @error('name')
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('email') }}"
                required
                class="w-full p-3 bg-gray-800 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary transition-colors @error('email') border-red-500 @else border-gray-600 @enderror"
              />
              @error('email')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
              @enderror
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                required
                class="w-full p-3 bg-gray-800 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary transition-colors @error('message') border-red-500 @else border-gray-600 @enderror"
